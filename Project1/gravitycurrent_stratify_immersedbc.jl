...
model = NonhydrostaticModel(; grid,
    ...
    # boundary_conditions = (u = u_bcs, w = w_bcs, b = b_bcs), # specify the boundary conditions that we defiend above
                boundary_conditions = (u = velocity_bcs, w = velocity_bcs, b = velocity_bcs), 
...
filename = "gravitycurrent_stratify_immersedbc"
